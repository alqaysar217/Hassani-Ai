      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden rounded-r-3xl border-none"
            style={
              {
          ...
          >
            <SheetHeader className="sr-only">
              ...
              <SheetDescription>قائمة المحادثات والإعدادات لتطبيق حساني الذكي</SheetDescription>
            </SheetHeader>
